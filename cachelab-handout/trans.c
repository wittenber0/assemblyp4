    ...
    if (N == 32){
        for (int bRow = 0; bRow < 4; bRow++){
            ...
            for (int bColumn = 0; bColumn < 4; bColumn++){
                ...
                for (int r = bRow * 8; r < bRow * 8 + 8; r++){
                    
                    if (bRow == bColumn){
                        B[r][r] = A[r][r];
                    }
                    for (int c = bColumn * 8; c < bColumn * 8 + 8; c++){
                        if (r != c){
                            B[r][c] = A[c][r];
                        }
                    }
        ...
        for (bRow = 0; bRow < 8; bRow++){
            for (bColumn = 0; bColumn < 8; bColumn++){
                for (c = bColumn * 8; c < bColumn * 8 + 4; c++){
                    for (r = bRow * 8; r < bRow * 8 + 4; r++){
                        if (r != c){
                            B[r][c] = A[c][r];
                        }
                    }
                ...
                for (c = bColumn * 8 + 4; c < bColumn * 8 + 8; c++){
                    for (r = bRow * 8; r < bRow * 8 + 4; r++){
                        if (r != c - 4){
                            B[r][c] = A[c - 4][r + 4];
                        }
